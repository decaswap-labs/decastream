...
contract AddBalancerV2Pools is Script {
    ...
    function run() public {
        ...
        BalancerV2PoolRegistry _registry = BalancerV2PoolRegistry(helperConfig.getBalancerV2PoolRegistry());
        owner = helperConfig.getOwner();
        PoolInfo[] memory pools = getPools();
    ...
    function getPools() public pure returns (PoolInfo[] memory) {
        ...
        pools[69] = PoolInfo({
            pool: 0x37b18B10ce5635a84834b26095A0AE5639dCB752,
            tokenA: ETHx,
            tokenB: WETH,
            name: "ETHx-WETH",
            verified: true
        });
        // 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2-0xa35b1b31ce002fbf2058d22f30f95d405200a15b
        pools[70] = PoolInfo({
            pool: 0x37b18B10ce5635a84834b26095A0AE5639dCB752,
            tokenA: WETH,
            tokenB: ETHx,
        ...
        // 0xdacf5fa19b1f720111609043ac67a9818262850c-0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2
        pools[71] = PoolInfo({
        ...
        // 0xdAC17F958D2ee523a2206206994597C13D831ec7-0x40D16FC0246aD3160Ccc09B8D0D3A2cD28aE6C2f
        pools[74] = PoolInfo({
            pool: 0x8353157092ED8Be69a9DF8F95af097bbF33Cb2aF,
            tokenA: USDT,
            tokenB: GHO,
        ...
        // 0xae7ab96520de3a18e5e111b5eaab095312d7fe84-0xdAC17F958D2ee523a2206206994597C13D831ec7
        pools[75] = PoolInfo({
            pool: 0xBD3a698826d27563d08d459Faff2d5F6960e21Cf,
            tokenA: stETH,
            tokenB: USDT,
            name: "stETH-USDT",
            verified: true
        ...
        // 0xdAC17F958D2ee523a2206206994597C13D831ec7-0xae7ab96520de3a18e5e111b5eaab095312d7fe84
        pools[76] = PoolInfo({
            pool: 0xBD3a698826d27563d08d459Faff2d5F6960e21Cf,
            tokenA: WETH,
            tokenB: stETH,
